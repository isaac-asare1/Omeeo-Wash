final List<Map<String, dynamic>> washingServices = [
  ...
  },
  {
    ...
    "minPrice": 80,
    "maxPrice": 85,
    "image": 'assets/images/interior_deep.png',
    "description": {
      "desTitle":
  ...
  },
  {
    ...
    "minPrice": 85,
    "maxPrice": 90,
    "image": 'assets/images/soft_top.png',
    "description": {
      "desTitle":
      ...
      "description": [
        ...
        "Mould and Mildew removal to restore the soft top's original colour",
